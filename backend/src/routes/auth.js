...
function buildUserResponse(db, user, org) {
  ...
  return {
    ...
    signalEnabled: !!user.signal_enabled,
    infraviewEnabled: !!user.infraview_enabled,
    upscaleEnabled: !!user.upscale_enabled,
    fireReportEnabled: !!user.fire_report_enabled,
    firingRangeEnabled: !!user.firing_range_enabled,
    ...
    orgFeatureSignal: !!org?.feature_signal,
    orgFeatureInfraview: !!org?.feature_infraview,
    orgFeatureUpscale: !!org?.feature_upscale,
    orgFeatureFireReport: !!org?.feature_fire_report,
    orgFeatureFiringRange: !!org?.feature_firing_range,
    orgFeatureMfa: user.role === 'super_admin' ? true : !!org?.feature_mfa,
    orgMfaRequired: !!org?.mfa_required,
    orgFeatureSelfDelete: !!org?.feature_self_delete,
    orgSelfDeleteEnabled: !!org?.self_delete_enabled,
...
router.get('/me', optionalAuth, (req, res) => {
  ...
  const response = {
    ...
    signalEnabled: req.user.signalEnabled,
    infraviewEnabled: req.user.infraviewEnabled,
    upscaleEnabled: req.user.upscaleEnabled,
    fireReportEnabled: req.user.fireReportEnabled,
    firingRangeEnabled: req.user.firingRangeEnabled,
    ...
    orgFeatureSignal: req.user.orgFeatureSignal,
    orgFeatureInfraview: req.user.orgFeatureInfraview,
    orgFeatureUpscale: req.user.orgFeatureUpscale,
    orgFeatureFireReport: req.user.orgFeatureFireReport,
    orgFeatureFiringRange: req.user.orgFeatureFiringRange,
    orgFeatureMfa: req.user.orgFeatureMfa,
    orgMfaRequired: req.user.orgMfaRequired,
    orgFeatureSelfDelete: req.user.orgFeatureSelfDelete,
    orgSelfDeleteEnabled: req.user.orgSelfDeleteEnabled,
