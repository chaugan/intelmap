...
const OVERLAYS = [
  ...
  { id: 'traffic', toggleKey: 'toggleTraffic', visibleKey: 'trafficVisible', opacityKey: 'trafficOpacity', setOpacityKey: 'setTrafficOpacity', accent: 'accent-orange-500', shortcut: 'T' },
...
const OVERLAY_LABELS = {
  ...
  traffic: { no: 'Trafikkmeldinger', en: 'Traffic Info' },
