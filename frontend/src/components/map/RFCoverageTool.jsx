...
export default function RFCoverageTool() {
  ...
  // Portal target: the drawer container rendered by App.jsx
  const drawerContainer = document.getElementById('rf-coverage-drawer');
  if (!visible || !drawerContainer) return null;
  ...
  return createPortal(
    <>
      ...
      <div className="flex-1 overflow-y-auto text-sm text-slate-200">
