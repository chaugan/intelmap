    ...
    <div className="absolute inset-0" data-map-container>
      ...
      {pitch > 5 && (
        <button
          ...
          className={`absolute top-4 left-[4.5rem] z-10 w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-colors ${
            rotating
        ...
        >
          {rotating ? (
            ...
            // Rotation arrow with play button inside - thin arc with arrowhead
            <svg width="32" height="32" viewBox="0 0 100 100" fill="white">
              ...
              <path
                ...
                strokeLinecap="round"
              />
              {/* Arrowhead connected to arc end */}
              <polygon points="50,2 35,28 50,22 65,28" fill="white" />
              {/* Green play triangle in center */}
              <polygon points="42,35 42,65 62,50" fill="#22c55e" />
            </svg>
          )}
        </button>
      )}
